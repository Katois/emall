...
const (
	...
	PaymentServicePayProcedure = "/payment.PaymentService/Pay"
)
...
type PaymentService interface {
	Pay(ctx context.Context, req *PayReq, opts ...client.CallOption) (*PayResp, error)
}
...
func (c *PaymentServiceImpl) Pay(ctx context.Context, req *PayReq, opts ...client.CallOption) (*PayResp, error) {
	resp := new(PayResp)
	if err := c.conn.CallUnary(ctx, []interface{}{req}, resp, "Pay", opts...); err != nil {
		return nil, err
	}
	return resp, nil
}
	...
	Methods: []server.MethodInfo{
		{
			...
			MethodFunc: func(ctx context.Context, args []interface{}, handler interface{}) (interface{}, error) {
				req := args[0].(*PayReq)
				res, err := handler.(PaymentServiceHandler).Pay(ctx, req)
				if err != nil {
					return nil, err
				}
